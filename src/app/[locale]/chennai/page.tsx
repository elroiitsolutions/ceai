...
export async function generateMetadata() {
  ...
  return {
    title: data?.cityName ? `${data.cityName} - Government Policies` : 'Chennai - Government Policies',
    description: data?.subtitle || 'Capital of Tamil Nadu and India\'s rapid automotive and manufacturing hub.',
  };
}
...
export default async function ChennaiPage() {
  ...
  const subtitle = cityData?.subtitle || "Capital of Tamil Nadu and India's rapid automotive and manufacturing hub.";
  const cityName = cityData?.cityName || "Chennai";
