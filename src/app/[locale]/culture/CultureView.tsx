...
const CultureView: React.FC<CultureViewProps> = ({ data }) => {
  const t = useTranslations('Navigation');
  
  const title = data?.title || "Cultural Exchange";
  const subtitle = data?.subtitle || "Stay informed of the latest cultural programs and mutual understanding initiatives.";
  
  const sectionTitle = data?.sectionTitle || "Cultural Initiatives & Programs";
  const sectionSubtitle = data?.sectionSubtitle || "Bridging the gap between nations through shared cultural experiences.";
